    ...
    <>
      ...
      <div className="bg-white">
        <div className="container mx-auto px-4 pb-6">
          ...
          <div className="max-w-2xl mx-auto mt-4 -mb-6 p-2 bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-800 rounded-lg">
            <p className="text-red-600 dark:text-red-400 font-semibold text-center text-sm">
              Note: All the assignment due dates are on Canvas.
            </p>
          </div>
